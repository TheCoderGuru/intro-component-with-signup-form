...
- Solution URL: [Check out the code here](https://github.com/TheCoderGuru/intro-component-with-signup-form)
- Live Site URL: [Visit the live site here](https://intro-component-with-signup-form-two-plum.vercel.app/)
